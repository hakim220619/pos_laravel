                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="id" id="id" class="form-control form-control-solid" placeholder="Generate Otomatis" readonly value="{{ 'PRD' . rand(00000, 99999) * 30 }}" />
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="barcode" id="barcode" class="form-control" placeholder="Scans Barcode" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="harga_beli" id="harga_beli" onkeyup="sum();" class="form-control hrg_bli" placeholder="Harga Beli" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="harga_jual" id="harga_jual" onkeyup="sum();" class="form-control hrg_jul" placeholder="Harga Jual" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="profit" id="profit" class="form-control form-control-solid" placeholder="Profit" readonly />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_penjualan" id="kode_penjualan" class="form-control" placeholder="Kode Penjualan" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_pembelian" id="kode_pembelian" class="form-control" placeholder="Kode Pembelian" />
                        </div>
                    </div>
                    <div class="col-md-12">
